...
@pytest.mark.parametrize('request_line,expected', [
    ...
    ('GET http://example.com HTTP/1.1', ('GET', '/')),
    ('GET http://example.com#anchor HTTP/1.1', ('GET', '/')),
    ('GET http://example.com?key=value HTTP/1.1', ('GET', '/')),
    ('GET http://example.com?key=value&key=value&key=value,value,value HTTP/1.1', ('GET', '/')),
    ('GET http://example.com?key=value#anchor HTTP/1.1', ('GET', '/')),
